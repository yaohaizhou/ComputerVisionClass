...
def predict(X_test, Y_test, FCLayer1, FCLayer2, FCLayer3, bn1, bn2, tanh1, tanh2):
    # pdb.set_trace()
    z1 = FCLayer1(X_test)
...
for i in tqdm(range(0,epochs)):
    ...
    delta3 = backward_loss_FCLayer3 * tanh2.backward()
    ...
    delta2 = backward_loss_FCLayer2 * tanh1.backward()
    ...
    tmp_acc = predict(X_valid, Y_valid, FCLayer1, FCLayer2, FCLayer3, bn1, bn2, tanh1, tanh2)
    log(i, tmp_acc, "acc")
    log(i, loss, "loss")
    # if tmp_acc > best_acc:
...
###################################### testing
# predict(X_test, Y_test, FCLayer1_best, bn1_best, bn2_best, FCLayer2_best)
log.plot()
