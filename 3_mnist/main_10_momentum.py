...
# 搭建完整训练模型 数据集划分_OK 所有网络模型整合（前向传播+反向传播）_OK batch_OK
# BatchNorm OK
# 训练可视化Loss_OK acc_OK
# 搭建config文件
# 搭建Conv层
